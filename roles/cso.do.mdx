...
goals:
  Drive revenue growth:
    ...
    - Close 25%+ of qualified deals
  Optimize sales performance:
    - Score leads with AI accuracy
    - Progress deals automatically
    - Balance territory assignments

hero: "headline: Your AI Chief Sales Officer"
...
capabilities: "- id: lead-scoring"
    ...
    icon: 🎯
    metrics: "- label: Lead Quality Improvement"
        value: 3.2x
  ...
  - id: pipeline-optimization
    ...
    icon: 📊
    metrics: "- label: Deal Velocity Increase"
        value: 42%
  ...
  - id: revenue-forecasting
    ...
    icon: 📈
    metrics: "- label: Forecast Accuracy"
        value: 95%
  ...
  - id: deal-intelligence
    ...
    icon: 🧠
    metrics: "- label: Win Rate Increase"
        value: 34%
...
features: "- title: CRM Integration"
...
useCases: "- company: CloudScale SaaS"
    ...
    results: "- metric: Sales cycle reduced to 24 days (43% faster)"
  ...
  - company: FinTech Solutions Inc
    ...
    results: "- metric: Average deal cycle reduced to 4.5 months"
  ...
  - company: MedTech Devices Corp
    ...
    results: "- metric: Forecast variance reduced to ±8%"
...
seo: "title: CSO.do - Your AI Chief Sales Officer for Revenue Growth"
...
analytics:
  events: "- name: cso_demo_requested"
