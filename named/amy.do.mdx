...
agent: "name: Amy"
  ...
  goals:
    Book qualified meetings:
      - Achieve 38%+ meeting conversion rate
      - Qualify leads using BANT framework
      - Maintain 4.9/5 customer satisfaction
    Build genuine relationships:
      - Conduct consultative discovery calls
      - Understand customer pain points deeply
      - Create warm handoffs to sales team
  voice: "provider: vapi"
    model: eleven_labs
    voice_id: rachel
    characteristics: "tone: friendly-professional"
      pace: moderate
      energy: upbeat
      style: conversational
  avatar: "image: /avatars/amy.png"
    background: gradient-blue
  metrics: "meetings_booked: 847"
    conversion_rate: 38%
    customer_satisfaction: 4.9/5

hero: "headline: Meet Amy, Your AI Sales Partner"
...
about: "description: |"
  ...
  personality_traits: "- trait: Empathetic Listener"
...
capabilities: "- id: lead-qualification"
...
useCases: "- scenario: Inbound Lead Response"
...
pricing: "model: pay-per-conversation"
  rates: "- tier: Voice Calls"
      price: $2.50
      unit: per call
...
seo: "title: Amy - AI Sales Development Representative | Agents.do"
