...
goals:
  Maximize customer lifetime value:
    ...
    - Achieve 4.8/5 satisfaction score
    - Drive 30%+ net revenue retention
  Prevent churn proactively:
    - Score customer health continuously
    - Intervene before churn signals
    - Personalize onboarding journeys

hero: "headline: Your AI Chief Customer Officer"
...
capabilities: "- id: health-monitoring"
  ...
  - id: churn-prevention
    ...
    icon: 🛡️
    metrics: "- label: Churn Prediction Accuracy"
        value: 89%
  ...
  - id: onboarding-automation
    ...
    icon: 🚀
    metrics: "- label: Time to First Value"
        value: 60% faster
  ...
  - id: expansion-management
    ...
    icon: 📈
    metrics: "- label: Net Revenue Retention"
        value: 125%
...
features: "- title: Unified Customer View"
...
useCases: "- company: SaaS Growth Platform"
    industry: B2B SaaS
    ...
    results: "- metric: Churn rate reduced to 8% (44% improvement)"
  ...
  - company: DataAnalytics Corp
    ...
    results: "- metric: Onboarding time reduced to 18 days (60% faster)"
  ...
  - company: Enterprise CloudOps
    ...
    results: "- metric: Net Revenue Retention up to 132%"
...
integrations:
  categories: "- name: Customer Success Platforms"
      description: Sync with CS and account management platforms
      integrations: "- name: Gainsight"
...
routes:
  collections: "- name: capabilities"
      ...
      data: "- capability: health-monitoring"
...
seo: "title: CCO.do - Your AI Chief Customer Officer for Customer Success"
...
analytics:
  events: "- name: cco_demo_requested"
