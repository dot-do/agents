...
agent:
  ...
  metrics:
    projects_coordinated: 1240
    on_time_delivery: 96%
    efficiency_gain: 42%

hero:
  headline: Meet Taylor, Your AI Operations Coordinator
...
about:
  ...
  personality_traits:
    - trait: Systematically Organized
...
seo:
  title: Taylor - AI Operations Coordinator | Agents.do
