---
hero:
  headline: Your AI Chief Operating Officer
...
useCases:
  - company: ShipFast Logistics
    ...
    results:
      - metric: On-time delivery improved to 98%
  ...
  - company: BuildRight Supply
    ...
    results:
      - metric: Inventory carrying costs down 34%
...
seo:
  title: COO.do - Your AI Chief Operating Officer for Operations Excellence
