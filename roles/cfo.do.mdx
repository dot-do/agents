...
goals:
  Optimize financial performance:
    ...
    - Maintain 6+ months cash reserve
    - Close books in under 24 hours
  Enable strategic finance:
    - Provide real-time financial insights
    - Identify cost optimization opportunities
    - Support data-driven investment decisions

hero: "headline: Your AI Chief Financial Officer"
  ...
  cta:
    primary: "text: Start Free Trial"
      url: /signup
    secondary: "text: Book Demo"
      url: /demo
  badges: "- text: AI-Powered"
      icon: sparkles
    - text: GAAP Compliant
      icon: certification
...
useCases: "headline: Real-World Use Cases"
  description: How finance teams use CFO.do
  items: "- title: Scaling Financial Operations"
...
routes: "- pattern: /capabilities/[capability]/readme.mdx"
...
seo: "title: CFO.do - AI Chief Financial Officer | Automated Financial Management"
